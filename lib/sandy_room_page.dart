...
class SandyRoomPage extends StatefulWidget {
  const SandyRoomPage({super.key});

  @override
  State<SandyRoomPage> createState() =>
      _SandyRoomPageState();
}

class _SandyRoomPageState extends State<SandyRoomPage> {

  @override
  Widget build(BuildContext context) {

    List<String> rooms = RoomData.rooms.keys
        .where((room) => room.startsWith("Sandy"))
        .toList();
